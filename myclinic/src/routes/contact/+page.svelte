...
<section class="bg-white dark:bg-gray-900">
    ...
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Still not sure? We are more than happy to talk to you and show you around.</p>
        <form method="POST" action="?/contact" class="space-y-8" use:enhance>
            <div>
            ...
            <div>
                ...
                <input type="text" name="company" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Scruber" required>
            </div>
            <div>
