...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="flex items-center justify-between pb-4 bg-white">
        <div>
            <button  on:click={()=>userModal = true} class="inline-flex mt-4 ml-4 items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 sm:pr-4" type="button">
                
                New patient
                <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white pl-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <div class="pl-3">
                        <a href="/dashboard/patients/{user.id}" class="text-base font-semibold hover:underline">{user.name} {user.surname}</a>
          ...
          <div class="relative overflow-hidden bg-white rounded-b-lg shadow-md dark:bg-gray-800">
            <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0"
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span
                  class="font-semibold text-gray-900 dark:text-white">1-{users.length}</span> of <span
                  class="font-semibold text-gray-900 dark:text-white">{totalPatients}</span></span>
