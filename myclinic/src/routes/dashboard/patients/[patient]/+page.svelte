...
<div
	class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900 md:ml-64  pt-20"
>
	<div class="mb-4 col-span-full xl:mb-2 md:ml-64 ">
	...
	<!-- Right Content -->
	<div class="col-span-full xl:col-auto pt-10">
		<div
...
<div class="grid grid-cols-1 px-4 xl:grid-cols-2 xl:gap-4 md:ml-64">
	<div
